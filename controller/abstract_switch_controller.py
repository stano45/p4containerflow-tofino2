...
class AbstractSwitchController(ABC):
    def __init__(self, sw_name, sw_addr, sw_id, client_id):
        if sw_name != None:
    ...
    @abstractmethod
    def insertEcmpGroupSelectEntry(self, matchDstAddr, ecmp_base, ecmp_count, update_type="INSERT"):
        pass

    @abstractmethod
    def insertEcmpGroupRewriteSrcEntry(self, matchDstAddr, new_src, update_type="INSERT"):
        pass
